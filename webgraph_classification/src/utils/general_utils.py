...
def lxml2xpath(element):
    soup = BeautifulSoup(lxml.html.tostring(element), 'html.parser')
    return soup2xpath(soup)

def soup2xpath(element):
    """
...
# https://github.com/hayj/SystemTools/blob/master/systemtools/number.py#L5
